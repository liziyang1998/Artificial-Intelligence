...
public:
    ...
    //flag代表是否随机
    void Decline(int maxIterator, double Step, int flag);
    void Print();
};

void Grad::Init(int a, int b, double c)
{
    n = a; m = b;
...
void Grad::Decline(int maxIterator, double Step, int flag)
{
    int iterator = 0;
    while(1){
        iterator++; loss = 0;
